            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <form:form cssClass="mt-5 row " method="post" action="/admin/user/create" modelAttribute="newUser" enctype="multipart/form-data">
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <form:input path="email" type="email" class="form-control ${not empty errorEmail ? 'is-invalid':''}" id="inputEmail" aria-describedby="emailHelp" />
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <form:input path="password" type="password" class="form-control ${not empty errorPassword ? 'is-invalid':''}" id="inputPassword" />
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                <label for="formSelect" class="form-label">Role</label>
                                <form:select class="form-select" id="formSelect" aria-label="Default select example" path="role.name">
                                    <form:option value="ADMIN">ADMIN</form:option>
                                    <form:option value="USER">USER</form:option> </form:select>
                            </div>
