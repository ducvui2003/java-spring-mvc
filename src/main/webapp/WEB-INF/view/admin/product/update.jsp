    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <form:form cssClass="mt-5 row " method="post" action="/admin/product/update" modelAttribute="product"
                           enctype="multipart/form-data">
                    <h1>Create new user</h1>
                    <div class="col-12 col-md-6 mb-3">
                        <form:input path="id" type="text" hidden="hidden" value="${product.id}"/>
                        <label for="inputName" class="form-label">Name</label>
                        <c:set var="errorName">
                            <form:errors path="name" cssClass="invalid-feedback"/>
                        </c:set>
                        <form:input path="name" type="text"
                                    class="form-control ${not empty errorName ? 'is-invalid':''}" id="inputName"
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <form:input path="price" type="text"
                                    class="form-control  ${not empty errorPrice ? 'is-invalid':''}" id="inputPrice"
                                    value="${product.price}"/>
                    ...
                    <div class="col-12 col-md-12 mb-3">
                        ...
                        <form:textarea path="detailDesc"
                                       ...
                                       id="inputDetailDesc" aria-describedby="phoneHelp" value="${product.detailDesc}"/>
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <form:input path="shortDesc" type="text"
                                    ...
                                    id="inputShortDesc" aria-describedby="phoneHelp" value="${product.shortDesc}"/>
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        ...
                        <form:input path="quantity" type="text"
                                    class="form-control ${not empty errorQuantity ? 'is-invalid':''}" id="inputQuantity"
                                    aria-describedby="phoneHelp" value="${product.quantity}"/>
                        <form:errors cssClass="invalid-feedback" path="quantity"/>
                    </div>

                    <div class="col-12 col-md-6 mb-3">
                        <label for="formSelect" class="form-label">Factory</label>
                        <form:select class="form-select" id="formSelect" aria-label="Default select example"
                                     value="${product.factory}"
                                     path="factory">
                            <form:option value="ADMIN">NOKIA</form:option>
                    ...
                    <div class="col-12 mb-3">
                        <img id="avatarPreview" class=" mx-auto" src="" alt="avatar preview"
